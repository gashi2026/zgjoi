...
export const Architect = ({ size = 21 }) => (
  <Svg size={size}>
...
/* headphones */
export const Headphones = ({ size = 21 }) => (
  <Svg size={size}>
...
/* shoulder camera */
export const Camcorder = ({ size = 21 }) => (
  <Svg size={size}>
...
/* hammer and plank */
export const Carpenter = ({ size = 21 }) => (
  <Svg size={size}>
...
const CUSTOM: Record<string, (p: { size?: number }) => JSX.Element> = {
  alarm: Alarm,
  notary: Notary,
  architect: Architect,
  cutlery: Cutlery,
